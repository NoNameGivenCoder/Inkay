...
WUPS_GET_CONFIG() {
    ...
    WUPSConfigItemBoolean_AddToCategoryHandled(config, patching_cat, "connect_to_network", "Connect to the NoNameVerse", Config::connect_to_network, &connect_to_network_changed);
